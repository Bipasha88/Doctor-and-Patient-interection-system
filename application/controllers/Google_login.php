...
class Google_login extends CI_Controller {
 ...
 function login()
 {
  ...
  $google_client->setClientId('711360715053-svnc06f6at6m3k86oce8vf2olhcv0btm.apps.googleusercontent.com');

  $google_client->setClientSecret('Wc44H5IEDDmuN07H0UAHJJfw');
  ...
  {
   $login_button = '<a href="'.$google_client->createAuthUrl().'"><img src="'.base_url().'assets/img/google.png" /></a>';
